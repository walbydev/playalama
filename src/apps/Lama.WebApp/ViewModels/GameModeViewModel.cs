...
public static class GameModes
{
    ...
    [
        ...
        new(
            ...
            Icon:      "⚡",
            Name:      "Blitz",
            ShortDesc: "Chrono par joueur : 5, 10 ou 25 minutes. Le premier à 0 perd par forfait.",
            Badge:     "Rapide",
            Color:     "#f59e0b",
            FullDesc:  "En mode Blitz, chaque seconde compte. Chaque joueur dispose d'un temps limité (5, 10 ou 25 minutes). Le premier joueur qui atteint 0 perd par forfait et la partie s'arrête immédiatement. Les mots longs valent plus, les bonus se multiplient, mais le chrono ne s'arrête pas.",
            Rules:     ["Chronomètre individuel par joueur (5, 10 ou 25 min)", "Plateau 15×15 standard", "Le premier joueur à 0 perd par forfait", "Les tuiles en main ne sont pas soustraites du score", "Suggestions autorisées mais l'Elo n'est pas comptabilisé"],
            Options:   ["Durée par joueur (5 / 10 / 25 min)", "Nombre de joueurs (2–4)", "Langue du dictionnaire"],
            IsImplemented: true),
